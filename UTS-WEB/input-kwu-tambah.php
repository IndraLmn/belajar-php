...
<form action="input-kwu-tambah.php" method="POST">
      ...
      <input type="text" name="pembeli" placeholder="Ex. Indra" /><br>

      <label for="namabarang">Nama Barang :</label><br>
      <input type="text" name="namabarang" placeholder="Ex. Laptop" /><br>
      <br>
      ...
      <input type="number" name="hargabeli" placeholder="Ex. 8000000" /><br>
      <br>

      <label for="hargajual">Harga Jual :</label><br>
      <input type="number" name="hargajual" placeholder="Ex. 8500000" /><br>
      <br>
